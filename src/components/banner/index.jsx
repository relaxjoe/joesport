        ...
        <div class="banner-overlay">
          <div class="container">
            <div class="row">
              <div class="mx-auto col-md-8 col-sm-12">
                <div class="banner-text">
                  ...
                  <h6 class="white">
                    See more on{" "}
                    <a
                      href="https://github.com/relaxjoe?tab=repositories"
                      target="_blank"
                      rel="dofollow"
                      class="weblink"
                    >
                  ...
                  <p class="banner-text white">
                    Welcome to my portfolio, Below is my work and ways to
                    contact me!
                  </p>
                  <ul>
                    <li>
                      <a
                        href="https://www.linkedin.com/in/joseph-diebel/"
                        target="_blank"
                        rel="dofollow"
                        class="weblink"
                      >
              ...
              {/* <div class="col-md-4 col-sm-12"> <img src="/images/me.png" class="img-fluid wow fadeInUp responsive-images"/> </div> */}
            </div>
          </div>
        </div>
