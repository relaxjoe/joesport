function Navbar (){
  ...
  <div class="container"> <a class="navbar-brand navbar-logo" href="#"> {/* <img src="image/logo.png" alt="" class="logo-1"/> */} </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item"> <a class="nav-link" href="#" data-scroll-nav="5">Resume</a> </li> */}
